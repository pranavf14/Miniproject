...
$sql1="select * from guide where name='$Username' and dob='$dob1'";
$records=mysqli_query($conn,$sql1);
$row=mysqli_fetch_array($records);

if($row['name']==$Username && $row['dob']==$dob1 )
{
$sql = "UPDATE guide SET pass='$nPassword' WHERE name='$Username' and dob='$dob1'";
...
<body>
  ...
  <form name="Regform" action="guidech.php" method="post" autocomplete="off" >
     <div class ="border">
  	<div  class ="container">
