...
$sql="INSERT INTO `guide`(`rolln1`, `rolln2`, `name`, `pass`, `dob`) VALUES ('$rolln1','$rolln2','$Username','$conPassword','$dob')";
...
<div class="topnav">
  ...
  <form name="Regform" onsubmit="return valid()" method="post" autocomplete="off" action="Guidesignup.php">
     <div class ="border">
    <div  class ="container">
    <h1>Sign Up</h1>
