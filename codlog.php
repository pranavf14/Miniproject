...
//header('location :http://localhost/guide/gri.php');
$name = $_POST["Username"];
$pass = $_POST["Password"];
$md_pass=md5($pass);
$sql="select * from guide where name=\"$name\"";
...
{
  echo "      valid";
  header('location:http://localhost/test/cordin1.php');
    //header('location:http://localhost/test/main5.html');
  // header('location :http://localhost/guide/gri.php');
  // exit;
}
else
{
    ...
    echo '</script>';
    // header("location :http://localhost/guide/guidelog.html");
    // exit;
}
}
else
...
<body>
  ...
  <form name="Regform" action="codlog.php" method="post" autocomplete="off" >
     <div class ="border">
  	<div  class ="container">
   	...
   	<div class= "p">
         ...
         <input type="password" name="Password" placeholder="Create password" id="pass" /><br>
				 <a href="guidech.php">forgot password</a><br><br>
